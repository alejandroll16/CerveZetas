...
INSERT INTO CerveZetas_Usuario (email, nombre, apellidos, contraseña, telefono, ultima_conexion, fecha_nacimiento, foto, tipo_usuarios) 
values ('pabloverdu@admin.es', 'Pablo', 'Verdu', '1234', 600000001, SYSDATE, TO_DATE('31/12/2001', 'DD/MM/YYYY'), 'URL_IMAGEN', 'Admin');

INSERT INTO CerveZetas_Usuario (email, nombre, apellidos, contraseña, telefono, ultima_conexion, fecha_nacimiento, foto, tipo_usuarios, metodo_pago) 
